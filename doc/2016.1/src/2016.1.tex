...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[thick]
			...
			\tkzLabelSegment[below=2pt](A,B){\textit{distanceAhead}}
			\tkzLabelSegment[right=4pt](B,C){\textit{tower from top of robot}}
			\tkzLabelSegment[above left=2pt](C,A){\textit{shot}}
