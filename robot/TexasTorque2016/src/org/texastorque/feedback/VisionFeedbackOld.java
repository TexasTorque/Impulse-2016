...
public class VisionFeedbackOld {

	private static VisionFeedbackOld instance;
	...
	// singleton
	public static VisionFeedbackOld getInstance() {
		return instance == null ? instance = new VisionFeedbackOld() : instance;
	}
